...
public class AttackAction : Action
{
	...
	[Tooltip("The NPC View sense decision.")]
	public FocusDecision targetView;// Minimum angle gap between current and desired aim orientations.

	// The decide function, called on Update() (State controller - current state - transition - decision).
	public  bool Decide(StateController controller)
	{
		return targetView.Decide(controller);
	}
	...
	{
		if (targetView.Decide(controller)== false)
		{
			return false;
		}
